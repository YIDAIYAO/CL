...
import h5py
import random
from data import imageDataset,neuralDataset,poseDataset
...
W=9
hdf5_file ='seq_mouse_30_window_9_516session.hdf5'
...
model=SupConClipResNet(in_channel=newW,name1='resnet18', name2='neural_resnet18',flag='neural')
